...
int main(int argc, char *argv[])
{
 ...
 char messageErreure1[_BUFFER_SIZE_] = "Nom du projet incorecte ou deja existant\n";
 char messageErreure2[_BUFFER_SIZE_] = "Erreure saisir O pour oui N pour non(O/N|o/n)\n";


    char makefile = ' ';
        char  nomProjet[_BUFFER_SIZE_];
    printf("\t\tInitC\n");
