...
void VSCode(char * nomProjet){
    ...
    char cmdVSCode[_BUFFER_SIZE_] = "code . projets\\";
...
{
    char cmdListProjetDIR[_BUFFER_SIZE_] = "dir /B projets > .dirListProjets.txt";
    char nomProjetExistant[_BUFFER_SIZE_] =" ";
...
void copieFichierC(char * nomProjet){
   ...
   char cmdCOPYc[_BUFFER_SIZE_] = "copy model\\*.c projets\\";
...
void copieFichierH(char * nomProjet){
    ...
    char cmdCOPYh[_BUFFER_SIZE_] = "copy model\\*.h projets\\";
...
{
   char cmdCreeProjet[_BUFFER_SIZE_] = "mkdir projets\\";
    strcat(cmdCreeProjet, nomProjet);

    char cmdcreeArboSRC[_BUFFER_SIZE_] = "mkdir projets\\";
    strcat(cmdcreeArboSRC, nomProjet);
    strcat(cmdcreeArboSRC, "\\src");

    char cmdcreeArboOBJ[_BUFFER_SIZE_] = "mkdir projets\\";
        strcat(cmdcreeArboOBJ, nomProjet);
strcat(cmdcreeArboOBJ, "\\obj");

    char cmdcreeArboBIN[_BUFFER_SIZE_] = "mkdir projets\\";
    strcat(cmdcreeArboBIN, nomProjet);
    strcat(cmdcreeArboBIN, "\\bin");

    
    char cmdcreeArboSRCHeader[_BUFFER_SIZE_] = "mkdir projets\\";
...
void creeMakeFile(char * nomProjet){
   ...
   char cheminFicMakefile[_BUFFER_SIZE_] ="projets\\";
